...
public class WorldParser {
    ...
    private func decodeRoom(with scanner: Scanner, at index: Int) throws -> Room {
        ...
        var room = Room(virtualNumber: 0, name: "", description: "", zoneNumber: 0, roomFlags: .init(rawValue: 0), zresetCost: 0, sectorType: 0, exits: [], darkLevel: 3, extraDescriptions: [], maxCharacters: .infinite, maxLevel: .max, minLevel: 0, specFlags0: 0, dropRoom: nil)
        ...
        room.roomFlags = RoomFlags(rawValue: try consumeInt(with: scanner, named: "zoneFlags", virtualNumber: virtualNumber))
